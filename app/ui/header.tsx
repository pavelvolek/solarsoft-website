        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex flex-wrap lg:gap-7">
            <div className="flex items-center lg:order-2">
              <a
                href="#kontakt"
                className="uppercase text-white bg-primary-600 hover:bg-primary-700 focus:bg-primary-800 font-semibold rounded-sm text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 "
              >
                Konzultace zdarma
              </a>
              <button
